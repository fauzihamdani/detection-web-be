...
var OnvifServiceDevice = /** @class */ (function (_super) {
    ...
    OnvifServiceDevice.prototype.getSystemDateAndTime = function () {
        ...
        var soap = this.createRequestSoap(soapBody);
        return soap_1.requestCommand(this.oxaddr, 'GetSystemDateAndTime', soap).then(function (result) {
            var parsed = parseGetSystemDateAndTime(result.converted);
            if (parsed && parsed.date) {
                var deviceTime = parsed.date.getTime();
                var myTime = (new Date()).getTime();
                _this.timeDiff = deviceTime - myTime;
            }
            return result;
        });
    };
    ...
    OnvifServiceDevice.prototype.getUsers = function () {
        ...
        return soap_1.requestCommand(this.oxaddr, 'GetUsers', soap).then(function (result) {
            var _a, _b;
            var d = (_b = (_a = result.data) === null || _a === void 0 ? void 0 : _a.GetUserResponse) === null || _b === void 0 ? void 0 : _b.User;
    ...
    OnvifServiceDevice.prototype.setUser = function (params) {
        ...
        var soap = this.createRequestSoap(soapBody);
        return soap_1.requestCommand(this.oxaddr, 'SetUsers', soap);
    };
    ...
    OnvifServiceDevice.prototype.getService = function (params) {
        var soapBody = '';
