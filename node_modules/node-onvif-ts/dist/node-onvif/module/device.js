...
var OnvifDevice = /** @class */ (function (_super) {
    ...
    function OnvifDevice(configs) {
        ...
        if (('xaddr' in configs) && (configs.xaddr)) {
            ...
            var ourl = url_1.parse(_this.xaddr);
        ...
        _this.oxaddr = url_1.parse(_this.xaddr);
        if (_this.user) {
            _this.oxaddr.auth = _this.user + ':' + _this.pass;
        }
        _this.services = {
    ...
    OnvifDevice.prototype.fetchSnapshot = function () {
        ...
        return new Promise(function (resolve, reject) {
            var ourl = url_1.parse(_this.currentProfile.snapshot);
            var options = {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.services.ptz) {
                            return [2 /*return*/, Promise.reject(new Error('The device does not support snaphost or you have not authorized by the device'))];
                        }
                        x = params.speed.x || 0;
                        y = params.speed.y || 0;
                        z = params.speed.z || 0;
    ...
    OnvifDevice.prototype.getXaddr = function (directXaddr) {
        ...
        var path = url_1.parse(directXaddr).path;
    ...
    OnvifDevice.prototype.getUri = function (directUri) {
        ...
        if (!this.keepAddr)
            return directuri;
        var base = url_1.parse('http://' + this.address);
        var parts = url_1.parse(directuri);
        var newParts = {
            host: base.host,
    ...
    OnvifDevice.prototype.getSnapshotUri = function (directUri) {
        ...
        var newUri = url_1.format(newParts);
        return newUri;
    };
    return OnvifDevice;
